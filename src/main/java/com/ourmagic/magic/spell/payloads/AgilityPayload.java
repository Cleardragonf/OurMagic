...
public class AgilityPayload implements PayloadEffect {
    @Override
    ...
    public boolean apply(SpellContext context, SpellTarget target) {
        ...
        int duration = Math.round(20 * 22 * context.durationMultiplier() * context.utilityPower());
        ...
        context.burst(living.position().add(0, 0.35D, 0), ParticleTypes.CLOUD, 28, 0.55D, 0.035D);
        return true;
    }
}
